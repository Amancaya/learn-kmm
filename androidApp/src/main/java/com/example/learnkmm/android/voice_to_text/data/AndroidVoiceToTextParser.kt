package com.example.learnkmm.android.voice_to_text.data
...
import com.example.learnkmm.core.domain.util.CommonStateFlow
import com.example.learnkmm.core.domain.util.toCommonStateFlow
import com.example.learnkmm.voice_to_text.domain.VoiceToTextParser
import com.example.learnkmm.voice_to_text.domain.VoiceToTextParserState
...
class AndroidVoiceToTextParser(
    ...
    override fun onRmsChanged(rmsdB: Float) {
        _state.update { it.copy(
            powerRation = rmsdB * (1f/ (12f - (-2f))) //To normalize the range of values
        ) }
    }
